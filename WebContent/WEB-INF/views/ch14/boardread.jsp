		...
		<div class="mainCenter">
			...
			<div class="content">
				<div class="sector">
					...
					<a type="submit" class="btn btn-primary" href="boardlist2">목록</a>
					<c:if test="${sessionMid == board.bwriter}">
					<a type="submit" class="btn btn-warning" href="boardupdate?bno=${board.bno}">수정</a>
					<a type="submit" class="btn btn-danger" href="boarddelete?bno=${board.bno}">삭제</a>
					</c:if>
					</form>
